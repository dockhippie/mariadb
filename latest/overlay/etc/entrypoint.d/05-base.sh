...
declare -x MARIADB_TRANSACTION_ISOLATION
[[ -z "${MARIADB_TRANSACTION_ISOLATION}" ]] && MARIADB_TRANSACTION_ISOLATION=""
...
declare -x MARIADB_INNODB_READ_ONLY_COMPRESSED
[[ -z "${MARIADB_INNODB_READ_ONLY_COMPRESSED}" ]] && MARIADB_INNODB_READ_ONLY_COMPRESSED="ON"
